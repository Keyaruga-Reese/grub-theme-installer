...
sudo chmod +x GrubThemeDownloader.sh
sudo ./GrubThemeDownloader.sh

# Delete the first script after execution
sudo rm GrubThemeDownloader.sh
...
sudo mv GrubThemeChanger.sh /boot/grub/themes/GrubThemeChanger.sh
sudo chmod +x /boot/grub/themes/GrubThemeChanger.sh

# Run the second script after moving it.
sudo bash /boot/grub/themes/GrubThemeChanger.sh
...
sudo systemctl enable GrubThemeChanger.service
